...
function Disney(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
      ...
      <defs>
        ...
        >
          <stop stopColor="#0D0841" />
          <stop offset="1" stopColor="#381960" />
        </linearGradient>
        <clipPath id="a">
